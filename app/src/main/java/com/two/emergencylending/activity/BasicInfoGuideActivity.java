 ...
 * 修改备注：
 */
public class BasicInfoGuideActivity extends Activity implements View.OnClickListener {
    LinearLayout guide;
    View status_bar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_basic_info_guide);
...
//        status_bar.getBackground().setAlpha(102);
        guide = (LinearLayout) findViewById(R.id.ll_view);
