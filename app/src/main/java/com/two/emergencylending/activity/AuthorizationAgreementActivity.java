 ...
 * 修改备注：
 */
public class AuthorizationAgreementActivity extends BaseActivity implements Topbar.topbarClickListener {
    ...
    public int setContent() {
        return R.layout.layout_authorization;
    }
    ...
    public void loadWeb() {
        String url = "file:///android_asset/authorized_agreement.html";
