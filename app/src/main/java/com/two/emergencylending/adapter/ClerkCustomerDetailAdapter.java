...
public class ClerkCustomerDetailAdapter extends BaseAdapter {
    private Context mContext;
    private List<ClerkCustomerBean> customerList;
    private LayoutInflater inflater;
    CustomerDialog dialog;

    public ClerkCustomerDetailAdapter(Context context, List<ClerkCustomerBean> customerList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.item_clerk_customer_detail, parent, false);
            viewHolder = new ClerkCustomerDetailAdapter.ViewHolder();
        ...
        viewHolder.phone.setText(CommonUtils.phoneNumHide(itembean.getPhone()));
...
//            viewHolder.status.setBackground(IApplication.globleResource.getDrawable(R.drawable.btn_lineframe));
        ...
        viewHolder.date.setText(DateUtil.stringToDateWithoutNoSecond(itembean.getCreate_date()));
        return convertView;
    }
