 ...
 * 修改备注：
 */
public class ReviewProgressCotroller {
    private static final String TAG = ReviewProgressCotroller.class.getSimpleName();
    Activity mActivity;
    Map<String, String> parameter;
    ControllerCallBack mController;

    public ReviewProgressCotroller(Activity activity, ControllerCallBack controller) {
